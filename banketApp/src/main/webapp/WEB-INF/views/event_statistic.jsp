...
<BODY>
	...
	<div id="container">
		...
		<div id="up_line">
			<h2 align="center">СТАТИСТИКА ПО МЕРОПРИЯТИЯМ</h2>
		</div>
		<div id="menu">
			<menu>
		...
		<div id="main">
			...
			<div id="report">
				<table class="table">
					...
					<tbody>
						<c:forEach var="event" items="${listStatistic}" varStatus="counter">
							<tr>
								<td align="center"><c:out value="${counter.count}" /></td>
								<td><c:out value="${event.titleStatistic}" /></td>
								<td nowrap><c:out value="${event.profit}" /></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
